export namespace Realtime {
  ...
  export type ObjectType = "realtime.item" | "realtime.response" | "realtime.session" | "realtime.conversation"
  ...
  export type ContentPart = InputTextContentPart | InputAudioContentPart | TextContentPart | AudioContentPart
  ...
  export type Item = BaseItem & (SystemItem | UserItem | AssistantItem | FunctionCallItem | FunctionCallOutputItem)

  export type ClientItem = SystemItem | UserItem | AssistantItem | FunctionCallItem | FunctionCallOutputItem
