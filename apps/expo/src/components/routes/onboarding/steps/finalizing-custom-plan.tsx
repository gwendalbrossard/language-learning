...
const FinalizingCustomPlan: React.FC<StepProps> = ({ onContinue, onBack, progress }) => {
  ...
  return (
    <Step.Container className="justify-center">
      ...
      <Step.Header className="gap-4">
        <Step.HeaderTitle className="text-2xl">Finalizing Your Custom Plan...</Step.HeaderTitle>
        <Step.HeaderDescription className="text-lg">We're finalizing your personalized roadmap to success.</Step.HeaderDescription>
      </Step.Header>
...
export default FinalizingCustomPlan
